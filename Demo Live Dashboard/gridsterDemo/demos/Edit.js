...
for (var i = 0; i < sidePanelItems.length; i++) {
  ...
  tilesData.push(data);
  element.innerHTML = '<span><span>' + sidePanelItems[i].key + '</span><br><span>Size:' + sidePanelItems[i].rows + 'X' + sidePanelItems[i].cols + '</span></span><span id="add-tile-btn' + (parseInt(i) + 1) + '" style="float: right; padding-top:5px; display: block; margin: auto 2px; cursor: pointer;"><i class="fa fa-plus"></i></span>';
...
$(function () {
  ...
  $("#add-tile-btn1").click(function () {
    ...
    var newDiv = '<div class="gs-w add-tile-btn1" id="chart-container"><div class="widget-button"><i class="fa fa-gear setting-icon"></i><i class="fa fa-close close-icon"></i></div></div>';
    ...
    document.getElementById('chart-container').setAttribute('style', "position: relative;");
  ...
  $("#add-tile-btn2").click(function () {
    ...
    var newDiv = '<div class="gs-w add-tile-btn2" id="chart-container-2"><div class="widget-button"><i class="fa fa-gear setting-icon"></i><i class="fa fa-close close-icon"></i></div><div style="margin-bottom:-10%;"><h1>OEE</h1></div></div>';
  ...
  $("#add-tile-btn6").click(function () {
    ...
    var chart = new ApexCharts(document.querySelector('#production-chart6'), chartOptions);
  ...
  $("#add-tile-btn9").click(function () {
    ...
    // create a new tile element
    var newDiv1 = '<div class="gs-w add-tile-btn9" id="chart-container-9" style="position: relative;"><div class="widget-button" style=""><i class="fa fa-gear" style=" /* font-size: 18px; */ "></i><i class="fa fa-close close-icon"></i></div><span class="gs-resize-handle gs-resize-handle-both"></span><div class="chart-header"> <div id="header">Machine Status</div><div class="color-legends" style=""> <div class="legend"> <span id="box-1" style=" background-color: lightblue; "></span><span class="legend-title">Plan</span></div><div class="legend"> <span id="box-1" style=" background-color: Pink; "></span><span class="legend-title">Actual</span></div></div>';
    addWidgetInAvailableSpace(size_width, size_height, newDiv1, 'add-tile-btn9');
    addCloseEventListner();
    ...
    const chart = new ApexCharts(document.querySelector('#production-chart9'), options);
  ...
  $("#add-tile-btn10").click(function () {
    ...
    // create a new tile element
    var newDiv1 = '<div class="gs-w add-tile-btn10" id="chart-container-10" style="position: relative;"><div class="widget-button" style=""><i class="fa fa-gear" style=" /* font-size: 18px; */ "></i><i class="fa fa-close close-icon"></i></div><span class="gs-resize-handle gs-resize-handle-both"></span><div class="chart-header"> <div id="header">Quality Status</div><div class="color-legends" style=""> <div class="legend"> <span id="box-1" style=" background-color: lightblue; "></span><span class="legend-title">Plan</span></div><div class="legend"> <span id="box-1" style=" background-color: Pink; "></span><span class="legend-title">Actual</span></div></div>';

    addWidgetInAvailableSpace(size_width, size_height, newDiv1, 'add-tile-btn10');
    addCloseEventListner();

    const canvas = document.createElement('div');

    canvas.setAttribute('id', 'production-chart10');
    canvas.setAttribute('class', 'chart-area');
    document.getElementById('chart-container-10').appendChild(canvas);
    ...
    // Initialize the chart
    const chart = new ApexCharts(document.querySelector('#production-chart10'), options);
  ...
  $("#add-tile-btn11").click(function () {
    ...
    // Initialize the chart
    const chart = new ApexCharts(document.querySelector('#production-chart11'), options);
  ...
  $("#add-tile-btn12").click(function () {
    ...
    // Initialize the chart
    const chart = new ApexCharts(document.querySelector('#production-chart12'), options);
  ...
  $("#add-tile-btn13").click(function () {
    ...
    // Initialize the chart
    const chart = new ApexCharts(document.querySelector('#production-chart13'), options);
  ...
  $("#add-tile-btn14").click(function () {
    ...
    // Initialize the chart
    const chart = new ApexCharts(document.querySelector('#production-chart14'), options);
  ...
  $("#add-tile-btn15").click(function () {
    ...
    // Initialize the chart
    const chart = new ApexCharts(document.querySelector('#production-chart15'), options);
  ...
  $("#add-tile-btn16").click(function () {
    ...
    // Initialize the chart
    const chart = new ApexCharts(document.querySelector('#production-chart16'), options);
  ...
  $("#add-tile-btn17").click(function () {
    ...
    // create a new tile element
    var newDiv1 = '<div class="gs-w add-tile-btn17" id="chart-container-17" style="position: relative;"><div class="widget-button" style=""><i class="fa fa-gear" style=" /* font-size: 18px; */ "></i><i class="fa fa-close close-icon"></i></div><span class="gs-resize-handle gs-resize-handle-both"></span><div class="chart-header"> <div id="header">Production Progress</div><div class="color-legends" style=""> <div class="legend"> <span id="box-1" style=" background-color: lightblue; "></span><span class="legend-title">Plan</span></div><div class="legend"> <span id="box-1" style=" background-color: Pink; "></span><span class="legend-title">Actual</span></div></div>';
    addWidgetInAvailableSpace(size_width, size_height, newDiv1, 'add-tile-btn17');
    addCloseEventListner();
    ...
    // Initialize the chart
    const chart = new ApexCharts(document.querySelector('#production-chart17'), options);
  ...
  $("#add-tile-btn18").click(function () {
    ...
    // create a new tile element
    var newDiv1 = '<div class="gs-w add-tile-btn18" id="chart-container-18" style="position: relative;"><div class="widget-button" style=""><i class="fa fa-gear" style=" /* font-size: 18px; */ "></i><i class="fa fa-close close-icon"></i></div><span class="gs-resize-handle gs-resize-handle-both"></span><div class="chart-header"> <div id="header">Production Progress</div><div class="color-legends" style=""> <div class="legend"> <span id="box-1" style=" background-color: lightblue; "></span><span class="legend-title">Plan</span></div><div class="legend"> <span id="box-1" style=" background-color: Pink; "></span><span class="legend-title">Actual</span></div></div>';
    addWidgetInAvailableSpace(size_width, size_height, newDiv1, 'add-tile-btn18');
    addCloseEventListner();
    ...
    // Initialize the chart
    const chart = new ApexCharts(document.querySelector('#production-chart18'), options);
  ...
  $("#add-tile-btn19").click(function () {
    ...
    // create a new tile element
    var newDiv1 = '<div class="gs-w add-tile-btn19" id="chart-container-19" style="position: relative;"><div class="widget-button" style=""><i class="fa fa-gear" style=" /* font-size: 18px; */ "></i><i class="fa fa-close close-icon"></i></div><span class="gs-resize-handle gs-resize-handle-both"></span><div class="chart-header"> <div id="header">Production Progress</div><div class="color-legends" style=""> <div class="legend"> <span id="box-1" style=" background-color: lightblue; "></span><span class="legend-title">Plan</span></div><div class="legend"> <span id="box-1" style=" background-color: Pink; "></span><span class="legend-title">Actual</span></div></div>';
    addWidgetInAvailableSpace(size_width, size_height, newDiv1, 'add-tile-btn19');
    addCloseEventListner();
    ...
    // Initialize the chart
    const chart = new ApexCharts(document.querySelector('#production-chart19'), options);
  ...
  $("#add-tile-btn20").click(function () {
    ...
    // create a new tile element
    var newDiv1 = '<div class="gs-w add-tile-btn20" id="chart-container-20" style="position: relative;"><div class="widget-button" style=""><i class="fa fa-gear" style=" /* font-size: 18px; */ "></i><i class="fa fa-close close-icon"></i></div><span class="gs-resize-handle gs-resize-handle-both"></span><div class="chart-header"> <div id="header">Production Progress</div><div class="color-legends" style=""> <div class="legend"> <span id="box-1" style=" background-color: lightblue; "></span><span class="legend-title">Plan</span></div><div class="legend"> <span id="box-1" style=" background-color: Pink; "></span><span class="legend-title">Actual</span></div></div>';
    addWidgetInAvailableSpace(size_width, size_height, newDiv1, 'add-tile-btn20');
    addCloseEventListner();
    ...
    // Initialize the chart
    const chart = new ApexCharts(document.querySelector('#production-chart20'), options);
  ...
  $("#add-tile-btn21").click(function () {
    ...
    // create a new tile element
    var newDiv1 = '<div class="gs-w add-tile-btn21" id="chart-container-21" style="position: relative;"><div class="widget-button" style=""><i class="fa fa-gear" style=" /* font-size: 18px; */ "></i><i class="fa fa-close close-icon"></i></div><span class="gs-resize-handle gs-resize-handle-both"></span><div class="chart-header"> <div id="header">Production Progress</div><div class="color-legends" style=""> <div class="legend"> <span id="box-1" style=" background-color: lightblue; "></span><span class="legend-title">Plan</span></div><div class="legend"> <span id="box-1" style=" background-color: Pink; "></span><span class="legend-title">Actual</span></div></div>';
    addWidgetInAvailableSpace(size_width, size_height, newDiv1, 'add-tile-btn21');
    addCloseEventListner();
    ...
    // Initialize the chart
    const chart = new ApexCharts(document.querySelector('#production-chart21'), options);
  ...
  $("#add-tile-btn22").click(function () {
    ...
    // create a new tile element
    var newDiv1 = '<div class="gs-w add-tile-btn22" id="chart-container-22" style="position: relative;"><div class="widget-button" style=""><i class="fa fa-gear" style=" /* font-size: 18px; */ "></i><i class="fa fa-close close-icon"></i></div><span class="gs-resize-handle gs-resize-handle-both"></span><div class="chart-header"> <div id="header">Production Progress</div><div class="color-legends" style=""> <div class="legend"> <span id="box-1" style=" background-color: lightblue; "></span><span class="legend-title">Plan</span></div><div class="legend"> <span id="box-1" style=" background-color: Pink; "></span><span class="legend-title">Actual</span></div></div>';
    addWidgetInAvailableSpace(size_width, size_height, newDiv1, 'add-tile-btn22');
    addCloseEventListner();
    ...
    // Initialize the chart
    const chart = new ApexCharts(document.querySelector('#production-chart22'), options);
  ...
  $("#add-tile-btn23").click(function () {
    ...
    // create a new tile element
    var newDiv1 = '<div class="gs-w add-tile-btn23" id="chart-container-23" style="position: relative;"><div class="widget-button" style=""><i class="fa fa-gear" style=" /* font-size: 18px; */ "></i><i class="fa fa-close close-icon"></i></div><span class="gs-resize-handle gs-resize-handle-both"></span><div class="chart-header"> <div id="header">Production Progress</div><div class="color-legends" style=""> <div class="legend"> <span id="box-1" style=" background-color: lightblue; "></span><span class="legend-title">Plan</span></div><div class="legend"> <span id="box-1" style=" background-color: Pink; "></span><span class="legend-title">Actual</span></div></div>';
    addWidgetInAvailableSpace(size_width, size_height, newDiv1, 'add-tile-btn23');
    addCloseEventListner();
    ...
    // Initialize the chart
    const chart = new ApexCharts(document.querySelector('#production-chart23'), options);
  ...
  $("#add-tile-btn24").click(function () {
    ...
    // create a new tile element
    var newDiv1 = '<div class="gs-w add-tile-btn24" id="chart-container-24" style="position: relative;"><div class="widget-button" style=""><i class="fa fa-gear" style=" /* font-size: 18px; */ "></i><i class="fa fa-close close-icon"></i></div><span class="gs-resize-handle gs-resize-handle-both"></span><div class="chart-header"> <div id="header">Production Progress</div><div class="color-legends" style=""> <div class="legend"> <span id="box-1" style=" background-color: lightblue; "></span><span class="legend-title">Plan</span></div><div class="legend"> <span id="box-1" style=" background-color: Pink; "></span><span class="legend-title">Actual</span></div></div>';
    addWidgetInAvailableSpace(size_width, size_height, newDiv1, 'add-tile-btn24');
    addCloseEventListner();
    ...
    // Initialize the chart
    const chart = new ApexCharts(document.querySelector('#production-chart24'), options);
  ...
  $("#add-tile-btn25").click(function () {
    ...
    // create a new tile element
    var newDiv1 = '<div class="gs-w add-tile-btn25" id="chart-container-25" style="position: relative;"><div class="widget-button" style=""><i class="fa fa-gear" style=" /* font-size: 18px; */ "></i><i class="fa fa-close close-icon"></i></div><span class="gs-resize-handle gs-resize-handle-both"></span><div class="chart-header"> <div id="header">Production Progress</div><div class="color-legends" style=""> <div class="legend"> <span id="box-1" style=" background-color: lightblue; "></span><span class="legend-title">Plan</span></div><div class="legend"> <span id="box-1" style=" background-color: Pink; "></span><span class="legend-title">Actual</span></div></div>';
    addWidgetInAvailableSpace(size_width, size_height, newDiv1, 'add-tile-btn25');
    addCloseEventListner();
    ...
    // Initialize the chart
    const chart = new ApexCharts(document.querySelector('#production-chart25'), options);
  ...
  $("#add-tile-btn26").click(function () {
    ...
    // create a new tile element
    var newDiv1 = '<div class="gs-w add-tile-btn26" id="chart-container-26" style="position: relative;"><div class="widget-button" style=""><i class="fa fa-gear" style=" /* font-size: 18px; */ "></i><i class="fa fa-close close-icon"></i></div><span class="gs-resize-handle gs-resize-handle-both"></span><div class="chart-header"> <div id="header">Production Progress</div><div class="color-legends" style=""> <div class="legend"> <span id="box-1" style=" background-color: lightblue; "></span><span class="legend-title">Plan</span></div><div class="legend"> <span id="box-1" style=" background-color: Pink; "></span><span class="legend-title">Actual</span></div></div>';
    addWidgetInAvailableSpace(size_width, size_height, newDiv1, 'add-tile-btn26');
    addCloseEventListner();
    ...
    // Initialize the chart
    const chart = new ApexCharts(document.querySelector('#production-chart26'), options);
  ...
  $("#add-tile-btn27").click(function () {
    ...
    // create a new tile element
    var newDiv1 = '<div class="gs-w add-tile-btn27" id="chart-container-27" style="position: relative;"><div class="widget-button" style=""><i class="fa fa-gear" style=" /* font-size: 18px; */ "></i><i class="fa fa-close close-icon"></i></div><span class="gs-resize-handle gs-resize-handle-both"></span><div class="chart-header"> <div id="header">Production Progress</div><div class="color-legends" style=""> <div class="legend"> <span id="box-1" style=" background-color: lightblue; "></span><span class="legend-title">Plan</span></div><div class="legend"> <span id="box-1" style=" background-color: Pink; "></span><span class="legend-title">Actual</span></div></div>';
    addWidgetInAvailableSpace(size_width, size_height, newDiv1, 'add-tile-btn27');
    addCloseEventListner();
    ...
    // Initialize the chart
    const chart = new ApexCharts(document.querySelector('#production-chart27'), options);
  ...
  $("#add-tile-btn28").click(function () {
    ...
    // create a new tile element
    var newDiv1 = '<div class="gs-w add-tile-btn28" id="chart-container-28" style="position: relative;"><div class="widget-button" style=""><i class="fa fa-gear" style=" /* font-size: 18px; */ "></i><i class="fa fa-close close-icon"></i></div><span class="gs-resize-handle gs-resize-handle-both"></span><div class="chart-header"> <div id="header">Production Progress</div><div class="color-legends" style=""> <div class="legend"> <span id="box-1" style=" background-color: lightblue; "></span><span class="legend-title">Plan</span></div><div class="legend"> <span id="box-1" style=" background-color: Pink; "></span><span class="legend-title">Actual</span></div></div>';
    addWidgetInAvailableSpace(size_width, size_height, newDiv1, 'add-tile-btn28');
    addCloseEventListner();
    ...
    // Initialize the chart
    const chart = new ApexCharts(document.querySelector('#production-chart28'), options);
  ...
  $("#add-tile-btn29").click(function () {
    ...
    // create a new tile element
    var newDiv1 = '<div class="gs-w add-tile-btn29" id="chart-container-29" style="position: relative;"><div class="widget-button" style=""><i class="fa fa-gear" style=" /* font-size: 18px; */ "></i><i class="fa fa-close close-icon"></i></div><span class="gs-resize-handle gs-resize-handle-both"></span><div class="chart-header"> <div id="header">Production Progress</div><div class="color-legends" style=""> <div class="legend"> <span id="box-1" style=" background-color: lightblue; "></span><span class="legend-title">Plan</span></div><div class="legend"> <span id="box-1" style=" background-color: Pink; "></span><span class="legend-title">Actual</span></div></div>';
    addWidgetInAvailableSpace(size_width, size_height, newDiv1, 'add-tile-btn29');
    addCloseEventListner();
    ...
    // Initialize the chart
    const chart = new ApexCharts(document.querySelector('#production-chart29'), options);
  ...
  $("#add-tile-btn30").click(function () {
    ...
    // create a new tile element
    var newDiv1 = '<div class="gs-w add-tile-btn30" id="chart-container-30" style="position: relative;"><div class="widget-button" style=""><i class="fa fa-gear" style=" /* font-size: 18px; */ "></i><i class="fa fa-close close-icon"></i></div><span class="gs-resize-handle gs-resize-handle-both"></span><div class="chart-header"> <div id="header">Production Progress</div><div class="color-legends" style=""> <div class="legend"> <span id="box-1" style=" background-color: lightblue; "></span><span class="legend-title">Plan</span></div><div class="legend"> <span id="box-1" style=" background-color: Pink; "></span><span class="legend-title">Actual</span></div></div>';
    addWidgetInAvailableSpace(size_width, size_height, newDiv1, 'add-tile-btn30');
    addCloseEventListner();
    ...
    // Initialize the chart
    const chart = new ApexCharts(document.querySelector('#production-chart30'), options);
  ...
  $("#add-tile-btn31").click(function () {
    ...
    // create a new tile element
    var newDiv1 = '<div class="gs-w add-tile-btn31" id="chart-container-31" style="position: relative;"><div class="widget-button" style=""><i class="fa fa-gear" style=" /* font-size: 18px; */ "></i><i class="fa fa-close close-icon"></i></div><span class="gs-resize-handle gs-resize-handle-both"></span><div class="chart-header"> <div id="header">Production Progress</div><div class="color-legends" style=""> <div class="legend"> <span id="box-1" style=" background-color: lightblue; "></span><span class="legend-title">Plan</span></div><div class="legend"> <span id="box-1" style=" background-color: Pink; "></span><span class="legend-title">Actual</span></div></div>';
    addWidgetInAvailableSpace(size_width, size_height, newDiv1, 'add-tile-btn31');
    addCloseEventListner();
    ...
    // Initialize the chart
    const chart = new ApexCharts(document.querySelector('#production-chart31'), options);
  ...
  $("#add-tile-btn32").click(function () {
    ...
    // create a new tile element
    var newDiv1 = '<div class="gs-w add-tile-btn32" id="chart-container-32" style="position: relative;"><div class="widget-button" style=""><i class="fa fa-gear" style=" /* font-size: 18px; */ "></i><i class="fa fa-close close-icon"></i></div><span class="gs-resize-handle gs-resize-handle-both"></span><div class="chart-header"> <div id="header">Production Progress</div><div class="color-legends" style=""> <div class="legend"> <span id="box-1" style=" background-color: lightblue; "></span><span class="legend-title">Plan</span></div><div class="legend"> <span id="box-1" style=" background-color: Pink; "></span><span class="legend-title">Actual</span></div></div>';
    addWidgetInAvailableSpace(size_width, size_height, newDiv1, 'add-tile-btn32');
    addCloseEventListner();
    ...
    // Initialize the chart
    const chart = new ApexCharts(document.querySelector('#production-chart32'), options);
  ...
  $("#add-tile-btn33").click(function () {
    ...
    // create a new tile element
    var newDiv1 = '<div class="gs-w add-tile-btn33" id="chart-container-33" style="position: relative;"><div class="widget-button" style=""><i class="fa fa-gear" style=" /* font-size: 18px; */ "></i><i class="fa fa-close close-icon"></i></div><span class="gs-resize-handle gs-resize-handle-both"></span><div class="chart-header"> <div id="header">Production Progress</div><div class="color-legends" style=""> <div class="legend"> <span id="box-1" style=" background-color: lightblue; "></span><span class="legend-title">Plan</span></div><div class="legend"> <span id="box-1" style=" background-color: Pink; "></span><span class="legend-title">Actual</span></div></div>';
    addWidgetInAvailableSpace(size_width, size_height, newDiv1, 'add-tile-btn33');
    addCloseEventListner();
    ...
    // Initialize the chart
    const chart = new ApexCharts(document.querySelector('#production-chart33'), options);
  ...
  $("#add-tile-btn34").click(function () {
    ...
    // create a new tile element
    var newDiv1 = '<div class="gs-w add-tile-btn34" id="chart-container-34" style="position: relative;"><div class="widget-button" style=""><i class="fa fa-gear" style=" /* font-size: 18px; */ "></i><i class="fa fa-close close-icon"></i></div><span class="gs-resize-handle gs-resize-handle-both"></span><div class="chart-header"> <div id="header">Production Progress</div><div class="color-legends" style=""> <div class="legend"> <span id="box-1" style=" background-color: lightblue; "></span><span class="legend-title">Plan</span></div><div class="legend"> <span id="box-1" style=" background-color: Pink; "></span><span class="legend-title">Actual</span></div></div>';
    addWidgetInAvailableSpace(size_width, size_height, newDiv1, 'add-tile-btn34');
    addCloseEventListner();
    ...
    // Initialize the chart
    const chart = new ApexCharts(document.querySelector('#production-chart34'), options);
  ...
  $("#add-tile-btn35").click(function () {
    ...
    // create a new tile element
    var newDiv1 = '<div class="gs-w add-tile-btn35" id="chart-container-35" style="position: relative;"><div class="widget-button" style=""><i class="fa fa-gear" style=" /* font-size: 18px; */ "></i><i class="fa fa-close close-icon"></i></div><span class="gs-resize-handle gs-resize-handle-both"></span><div class="chart-header"> <div id="header">Production Progress</div><div class="color-legends" style=""> <div class="legend"> <span id="box-1" style=" background-color: lightblue; "></span><span class="legend-title">Plan</span></div><div class="legend"> <span id="box-1" style=" background-color: Pink; "></span><span class="legend-title">Actual</span></div></div>';
    addWidgetInAvailableSpace(size_width, size_height, newDiv1, 'add-tile-btn35');
    addCloseEventListner();
    ...
    // Initialize the chart
    const chart = new ApexCharts(document.querySelector('#production-chart35'), options);
  ...
  $("#add-tile-btn36").click(function () {
    ...
    // create a new tile element
    var newDiv1 = '<div class="gs-w add-tile-btn36" id="chart-container-36" style="position: relative;"><div class="widget-button" style=""><i class="fa fa-gear" style=" /* font-size: 18px; */ "></i><i class="fa fa-close close-icon"></i></div><span class="gs-resize-handle gs-resize-handle-both"></span><div class="chart-header"> <div id="header">Production Progress</div><div class="color-legends" style=""> <div class="legend"> <span id="box-1" style=" background-color: lightblue; "></span><span class="legend-title">Plan</span></div><div class="legend"> <span id="box-1" style=" background-color: Pink; "></span><span class="legend-title">Actual</span></div></div>';
    addWidgetInAvailableSpace(size_width, size_height, newDiv1, 'add-tile-btn36');
    addCloseEventListner();
    ...
    // Initialize the chart
    const chart = new ApexCharts(document.querySelector('#production-chart36'), options);
  ...
  $("#add-tile-btn37").click(function () {
    ...
    // create a new tile element
    var newDiv1 = '<div class="gs-w add-tile-btn37" id="chart-container-37" style="position: relative;"><div class="widget-button" style=""><i class="fa fa-gear" style=" /* font-size: 18px; */ "></i><i class="fa fa-close close-icon"></i></div><span class="gs-resize-handle gs-resize-handle-both"></span><div class="chart-header"> <div id="header">Production Progress</div><div class="color-legends" style=""> <div class="legend"> <span id="box-1" style=" background-color: lightblue; "></span><span class="legend-title">Plan</span></div><div class="legend"> <span id="box-1" style=" background-color: Pink; "></span><span class="legend-title">Actual</span></div></div>';
    addWidgetInAvailableSpace(size_width, size_height, newDiv1, 'add-tile-btn37');
    addCloseEventListner();
    ...
    // Initialize the chart
    const chart = new ApexCharts(document.querySelector('#production-chart37'), options);
  ...
  $("#add-tile-btn38").click(function () {
    ...
    // create a new tile element
    var newDiv1 = '<div class="gs-w add-tile-btn38" id="chart-container-38" style="position: relative;"><div class="widget-button" style=""><i class="fa fa-gear" style=" /* font-size: 18px; */ "></i><i class="fa fa-close close-icon"></i></div><span class="gs-resize-handle gs-resize-handle-both"></span><div class="chart-header"> <div id="header">Production Progress</div><div class="color-legends" style=""> <div class="legend"> <span id="box-1" style=" background-color: lightblue; "></span><span class="legend-title">Plan</span></div><div class="legend"> <span id="box-1" style=" background-color: Pink; "></span><span class="legend-title">Actual</span></div></div>';
    addWidgetInAvailableSpace(size_width, size_height, newDiv1, 'add-tile-btn38');
    addCloseEventListner();
    ...
    // Initialize the chart
    const chart = new ApexCharts(document.querySelector('#production-chart38'), options);
  ...
  $("#add-tile-btn39").click(function () {
    ...
    // create a new tile element
    var newDiv1 = '<div class="gs-w add-tile-btn15" id="chart-container-39" style="position: relative;"><div class="widget-button" style=""><i class="fa fa-gear" style=" /* font-size: 18px; */ "></i><i class="fa fa-close close-icon"></i></div><span class="gs-resize-handle gs-resize-handle-both"></span><div class="chart-header"> <div id="header">Production Progress</div><div class="color-legends" style=""> <div class="legend"> <span id="box-1" style=" background-color: lightblue; "></span><span class="legend-title">Plan</span></div><div class="legend"> <span id="box-1" style=" background-color: Pink; "></span><span class="legend-title">Actual</span></div></div>';
    addWidgetInAvailableSpace(size_width, size_height, newDiv1, 'add-tile-btn39');
    addCloseEventListner();
    ...
    // Initialize the chart
    const chart = new ApexCharts(document.querySelector('#production-chart39'), options);
  ...
  $("#add-tile-btn40").click(function () {
    ...
    // create a new tile element
    var newDiv1 = '<div class="gs-w add-tile-btn40" id="chart-container-40" style="position: relative;"><div class="widget-button" style=""><i class="fa fa-gear" style=" /* font-size: 18px; */ "></i><i class="fa fa-close close-icon"></i></div><span class="gs-resize-handle gs-resize-handle-both"></span><div class="chart-header"> <div id="header">Production Progress</div><div class="color-legends" style=""> <div class="legend"> <span id="box-1" style=" background-color: lightblue; "></span><span class="legend-title">Plan</span></div><div class="legend"> <span id="box-1" style=" background-color: Pink; "></span><span class="legend-title">Actual</span></div></div>';
    addWidgetInAvailableSpace(size_width, size_height, newDiv1, 'add-tile-btn40');
    addCloseEventListner();
    ...
    // Initialize the chart
    const chart = new ApexCharts(document.querySelector('#production-chart40'), options);
  ...
  $("#add-tile-btn41").click(function () {
    ...
    // create a new tile element
    var newDiv1 = '<div class="gs-w add-tile-btn41" id="chart-container-41" style="position: relative;"><div class="widget-button" style=""><i class="fa fa-gear" style=" /* font-size: 18px; */ "></i><i class="fa fa-close close-icon"></i></div><span class="gs-resize-handle gs-resize-handle-both"></span><div class="chart-header"> <div id="header">Production Progress</div><div class="color-legends" style=""> <div class="legend"> <span id="box-1" style=" background-color: lightblue; "></span><span class="legend-title">Plan</span></div><div class="legend"> <span id="box-1" style=" background-color: Pink; "></span><span class="legend-title">Actual</span></div></div>';
    addWidgetInAvailableSpace(size_width, size_height, newDiv1, 'add-tile-btn41');
    addCloseEventListner();
    ...
    // Initialize the chart
    const chart = new ApexCharts(document.querySelector('#production-chart41'), options);
  ...
  $("#add-tile-btn42").click(function () {
    ...
    // create a new tile element
    var newDiv1 = '<div class="gs-w add-tile-btn42" id="chart-container-42" style="position: relative;"><div class="widget-button" style=""><i class="fa fa-gear" style=" /* font-size: 18px; */ "></i><i class="fa fa-close close-icon"></i></div><span class="gs-resize-handle gs-resize-handle-both"></span><div class="chart-header"> <div id="header">Production Progress</div><div class="color-legends" style=""> <div class="legend"> <span id="box-1" style=" background-color: lightblue; "></span><span class="legend-title">Plan</span></div><div class="legend"> <span id="box-1" style=" background-color: Pink; "></span><span class="legend-title">Actual</span></div></div>';
    addWidgetInAvailableSpace(size_width, size_height, newDiv1, 'add-tile-btn42');
    addCloseEventListner();
    ...
    // Initialize the chart
    const chart = new ApexCharts(document.querySelector('#production-chart42'), options);
  ...
  $("#add-tile-btn43").click(function () {
    ...
    // create a new tile element
    var newDiv1 = '<div class="gs-w add-tile-btn43" id="chart-container-43" style="position: relative;"><div class="widget-button" style=""><i class="fa fa-gear" style=" /* font-size: 18px; */ "></i><i class="fa fa-close close-icon"></i></div><span class="gs-resize-handle gs-resize-handle-both"></span><div class="chart-header"> <div id="header">Production Progress</div><div class="color-legends" style=""> <div class="legend"> <span id="box-1" style=" background-color: lightblue; "></span><span class="legend-title">Plan</span></div><div class="legend"> <span id="box-1" style=" background-color: Pink; "></span><span class="legend-title">Actual</span></div></div>';
    addWidgetInAvailableSpace(size_width, size_height, newDiv1, 'add-tile-btn43');
    addCloseEventListner();
    ...
    // Initialize the chart
    const chart = new ApexCharts(document.querySelector('#production-chart43'), options);
  ...
  $("#add-tile-btn44").click(function () {
    ...
    // create a new tile element
    var newDiv1 = '<div class="gs-w add-tile-btn44" id="chart-container-44" style="position: relative;"><div class="widget-button" style=""><i class="fa fa-gear" style=" /* font-size: 18px; */ "></i><i class="fa fa-close close-icon"></i></div><span class="gs-resize-handle gs-resize-handle-both"></span><div class="chart-header"> <div id="header">Production Progress</div><div class="color-legends" style=""> <div class="legend"> <span id="box-1" style=" background-color: lightblue; "></span><span class="legend-title">Plan</span></div><div class="legend"> <span id="box-1" style=" background-color: Pink; "></span><span class="legend-title">Actual</span></div></div>';
    addWidgetInAvailableSpace(size_width, size_height, newDiv1, 'add-tile-btn44');
    addCloseEventListner();
    ...
    // Initialize the chart
    const chart = new ApexCharts(document.querySelector('#production-chart44'), options);
    ...
    if (closeIcons.length !== 0) {
      closeIcons.forEach(function (icon) {
        icon.addEventListener("click", function () {
          // document.getElementById(icon.parentNode.parentNode.id).remove();
          gridster.remove_widget(document.getElementById(icon.parentNode.parentNode.id));
  ...
  document.getElementsByClassName("add-tile")[0].onclick = function (event) {
    document.getElementsByClassName("sidepanel")[0].style.visibility = 'visible';
...
fun3();
  ...
  function fun1(){
    ...
    // create a new tile element
    var newDiv = '<div class="gs-w init-add-tile-btn1" id="init-chart-container"><div class="widget-button"><i class="fa fa-gear setting-icon"></i><i class="fa fa-close close-icon"></i></div></div>';


    addWidgetInAvailableSpace(size_width, size_height, newDiv, 'init-add-tile-btn1');

    addCloseEventListner('init-add-tile-btn1');
    const canvas = document.createElement('div');
    canvas.setAttribute('id', 'init-production-chart1');

    canvas.setAttribute('class', 'chart-area');
    document.getElementById('init-chart-container').appendChild(canvas);
    document.getElementById('init-chart-container').setAttribute('style', "position: relative;");
    ...
    function fun2(){
      ...
      // create a new tile element
      var newDiv = '<div class="gs-w init-add-tile-btn7" id="init-chart-container-7" style="position: relative;"><div class="widget-button"><i class="fa fa-gear setting-icon"></i><i class="fa fa-close close-icon"></i></div><div class="title chart-area"> <table><tr><td>Lot Name</td><td>CKLJ_M4488_A</td></tr><tr><td>ASSY Name</td><td>KLJ_M4488</td></tr><tr><td>Product Name</td><td>CKLJ_M4488_A</td></tr><tr><td>Production Actual</td><td>70/70</td></tr><tr><td>Line Status</td><td>Stop</td></tr></table></div></div >';

      addWidgetInAvailableSpace(size_width, size_height, newDiv, 'init-add-tile-btn7');
      addCloseEventListner('init-add-tile-btn7');
    }
    ...
    // create a new tile element
    var newDiv1 = '<div class="gs-w init-add-tile-btn9" id="init-chart-container-9" style="position: relative;"><div class="widget-button" style=""><i class="fa fa-gear" style=" /* font-size: 18px; */ "></i><i class="fa fa-close close-icon"></i></div><span class="gs-resize-handle gs-resize-handle-both"></span><div class="chart-header"> <div id="header">Quality Status</div><div class="color-legends" style=""> <div class="legend"> <span id="box-1" style=" background-color: lightblue; "></span><span class="legend-title">Plan</span></div><div class="legend"> <span id="box-1" style=" background-color: Pink; "></span><span class="legend-title">Actual</span></div></div>';

    addWidgetInAvailableSpace(size_width, size_height, newDiv1, 'init-add-tile-btn9');
    addCloseEventListner('init-add-tile-btn9');
...
function fun4(){
  ...
  // create a new tile element
  var newDiv = '<div class="gs-w init-add-tile-btn8" id="init-chart-container-8" style="position: relative;"><div class="widget-button"><i class="fa fa-gear setting-icon"></i><i class="fa fa-close close-icon"></i></div><div class="title chart-area"><div ><h3 class ="rate-heading">Defective Rate</h3></div ><div><span class="rate-sub-heading"><h5>Pre-reflow</h5></span></div><div class="data"><span class="rate-value">0 ppm</span></div></div></div > ';
  addWidgetInAvailableSpace(size_width, size_height, newDiv, 'init-add-tile-btn8');
  addCloseEventListner('init-add-tile-btn8');
}

});

function hideAddFunctionality(id) {
  var divElement = document.getElementById(document.getElementById(id).parentNode.id);
  divElement.setAttribute('style', "opacity: 0.5;pointer-events: none;border-style: dotted !important;");
  document.getElementById(id).innerHTML = '';
  // Find the object with ID=2 and update the age key
  const foundObject = tilesData.find(tile => tile.spanId === document.getElementById(id).id);
  if (foundObject) {
...
function updateIcons() {
  tilesData.forEach(function (data) {
    if (data.spanInnerHtml !== '') {
      if (!data.canAdd) {
        document.getElementById(data.spanId).innerHTML = '<i class="fa fa-exclamation-triangle"></i>';
        data.spanInnerHtml = '<i class="fa fa-exclamation-triangle"></i>';
        data.previousSpanInnerHtml = '<i class="fa fa-exclamation-triangle"></i>';
      } else {
        document.getElementById(data.spanId).innerHTML = '<i class="fa fa-plus"></i>';
